...
:math:`\begin{bmatrix} i.x \\ i.y \\ i.z \end{bmatrix} - 2.0 * dot(\begin{bmatrix} n.x \\ n.y \\ n.z \end{bmatrix}, \begin{bmatrix} i.x \\ i.y \\ i.z \end{bmatrix}) * \begin{bmatrix} n.x \\ n.y \\ n.z \end{bmatrix}`
